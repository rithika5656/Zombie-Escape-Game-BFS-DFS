...
with st.sidebar:
    ...
    st.markdown("""
    **🎯 Goal:** Help the player escape before zombies catch them!
    
    **🧟 Zombie Spread (BFS)**
    - Click the red button to start
    - Zombies spread level-by-level
    - Uses Breadth-First Search algorithm
    
    **🏃 Find Escape (DFS)**
    - Click the green button
    - Finds path using Depth-First Search
    - Blue path shows escape route
    
    **🎮 Controls:**
    - Click cells to add/remove walls
    - Use slider to adjust speed
    - Generate random maps for variety
    
    **📊 Win/Lose:**
    - ✅ Win: Path to exit found
    - ❌ Lose: Zombies catch player
    """)
